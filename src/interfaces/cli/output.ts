...
export function formatConfigurationSummary(
    ...
    return JSON.stringify(
      {
        ...
        enabledCompanies: summary.enabledCompanyCount,
  ...
  return [
    ...
    `Enabled companies: ${summary.enabledCompanyCount}`,
...
export function formatHelp(): string {
  return [
    ...
    '  discover-company Discover one careers URL and persist its provider',
    '  discover-all     Discover all enabled configured companies',
    '  show-providers   List supported ATS providers',
    '  show-company     Show persisted discovery and crawl health for a company',
    '  show-discovery   Show all persisted company discovery records',
    '  health           Summarize collection health',
    '  coverage         Summarize companies and jobs by provider',
    '  collect          Collect jobs from enabled companies and supported sources',
    ...
    '  --type <type>        Collect one supported ATS or generic source type',
    '  --url <url>          Careers URL for discover-company',
    '  --company <id>       Company ID for show-company',
